                ...
                <nav aria-label="Pagination">
                    <ul className="inline-flex items-center -space-x-px rounded-md text-sm shadow-sm">
                        ...
                        <li className="lg:tooltip" data-tip="Current Page">
                            <div aria-current="page" className="inline-flex items-center border border-gray-500 hover:border-yellow-500 px-4 py-2 font-medium text-white-500 hover:text-gray-500 bg-yellow-500 hover:bg-gray-200 cursor-not-allowed">{page}</div>
                        </li>
